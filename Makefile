...
SIMAPP = ./app
HTTPS_GIT := https://github.com/Canto-Network/ethermint-test.git
...
PACKAGE_NAME:=github.com/Canto-Network/ethermint-test
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Canto-Network/ethermint-test/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Canto-Network/ethermint-test/tests/importer

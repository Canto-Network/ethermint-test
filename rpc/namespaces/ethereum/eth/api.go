...
import (
	...
	"github.com/Canto-Network/ethermint-test/ethereum/eip712"
	...
	rpctypes "github.com/Canto-Network/ethermint-test/rpc/types"
...
func (e *PublicAPI) Resend(ctx context.Context, args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/Canto-Network/ethermint-test/issues/905
